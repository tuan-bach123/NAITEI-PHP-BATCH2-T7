      ...
      <div class="flex items-center space-x-8">
        <div class="shrink-0">
          <a href="{{ route('home.index') }}" title="" class="">
            <h1 class="font-bold text-3xl">Soppe</h1>
          </a>
        </div>
      ...
      <div class="flex items-center lg:space-x-2">
        ...
        <div id="userDropdown1" class="hidden z-10 w-56 divide-y divide-gray-100 overflow-hidden overflow-y-auto rounded-lg bg-white antialiased shadow dark:divide-gray-600 dark:bg-gray-700">
          <ul class="p-2 text-start text-sm font-medium text-gray-900 dark:text-white">
            <li><a href="{{ route('profile.edit') }}" title="" class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600"> {{__('My Account')}} </a></li>
            <li><a href="#" title="" class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600"> {{__('My Orders')}} </a></li>
            <li><a href="#" title="" class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600"> {{__('Settings')}} </a></li>
            <li>
              <form method="POST" action="{{ route('logout') }}" class="inline-flex w-full">
                @csrf
                <button type="submit" class="w-full text-left px-3 py-2 rounded-md text-sm hover:bg-gray-100 dark:hover:bg-gray-600">{{__('Logout')}}</button>
              </form>
            </li>
          </ul>
        </div>
