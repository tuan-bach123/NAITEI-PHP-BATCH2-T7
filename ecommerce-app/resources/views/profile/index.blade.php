                        ...
                        <div class="py-4 md:py-8">
                            <div class="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
                                <div class="space-y-4">
                                    <div class="flex space-x-4">
                                        <img class="h-16 w-16 rounded-lg"
                                            src="{{ file_exists(public_path('images/' . Auth::user()->id . '.jpg')) ? asset('images/' . Auth::user()->id . '.jpg') : 'https://www.svgrepo.com/show/452030/avatar-default.svg' }}"
                                            alt="Avatar" />
                                        <div>
                                            <h2
                                ...
                                <div class="space-y-4">
                                    ...
                                    <dl>
                                        <dt class="font-semibold text-gray-900 dark:text-white">Favorite pick-up point
                                        </dt>
                                    ...
                                    <dl>
                                        ...
                                        <dd class="text-gray-500 dark:text-gray-400">FLOWBITE LLC, Fiscal code: 18673557
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt class="mb-1 font-semibold text-gray-900 dark:text-white">Payment Methods
                                        </dt>
                                        <dd class="flex items-center space-x-4 text-gray-500 dark:text-gray-400">
                                            ...
                                            <div>
                                                <div class="text-sm">
                                                    <p class="mb-0.5 font-medium text-gray-900 dark:text-white">Visa
                                                        ending in 7658</p>
                                                    <p class="font-normal text-gray-500 dark:text-gray-400">Expiry
                                                        10/2024</p>
                                                </div>
                                            </div>
                                        </dd>
                            ...
                            <button type="button" data-modal-target="accountInformationModal2"
                                ...
                                class="inline-flex w-7 items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:w-auto">
